...
const config = {
    ...
    packname: process.env.PACKNAME || 'TEDDY-XMD',
    ...
    // Links
    channelLink: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb6NveDBPzjPa4vIRt3n',
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/Teddytech1/TEDDY-XMD/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'Teddytechhub',
    // Session
