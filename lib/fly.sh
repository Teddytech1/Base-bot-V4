#!/bin/bash
#TEDDY-XMD Fly.io One-Click Deployer
# Usage: bash <(curl -s https://raw.githubusercontent.com/Teddytech1/TEDDY-XMD/main/lib/fly.sh)
...
echo -e "${CYAN}"
echo "╔═══════════════════════════════════════╗"
echo "║        TEDDY-XMD Fly.io Deployer        ║"
echo "║          by Teddy            ║"
echo "╚═══════════════════════════════════════╝"
echo -e "${NC}"
